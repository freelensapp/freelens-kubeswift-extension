...
| Create SwiftGuestClass / Image / Kernel / SeedProfile (forms) | [SPEC-0014](../specs/SPEC-0014-m6-simple-creation-forms.md) | In PR |
| Create SwiftGuestPool (form) | [SPEC-0015](../specs/SPEC-0015-m6-create-guest-pool-form.md) | Spec in PR |

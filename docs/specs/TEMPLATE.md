...
Which kubeswift-ui screens or KubeSwift docs this feature mirrors
(links). Reminder: visual and domain reference only, no code copying
(AGPL boundary, see ARCHITECTURE.md).
...
- CRDs involved, fields read/written (from `config/crd/bases/` schemas).
